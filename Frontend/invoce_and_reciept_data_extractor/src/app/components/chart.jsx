          ...
          {userId && (
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-6">
                ...
                <div className="flex flex-wrap gap-3">
                  {["All", "Food", "Transport", "Entertainment", "Utilities", "Shopping", "Healthcare"].map((c) => (
                    <button
                      ...
                      className={`
                        px-6 py-3 rounded-2xl font-bold text-sm uppercase tracking-wider transition-all duration-300 
                        transform hover:scale-105 border border-[#3341551a] shadow-lg
                        ${category === c 
                          ? 'text-white' 
                          : 'text-[#0F172A] bg-white/80 hover:bg-white'
                        }
                      `}
                      style={{
                ...
                {/* Time Buttons - Right Side */}
                <div className="flex gap-3 bg-white/80 rounded-2xl p-2 border border-[#3341551a] shadow-lg">
                  {["Month", "Week"].map((t) => (
                    <button
                      key={t}
                      onClick={() => setTimeView(t)}
                      className={`
                        px-6 py-3 rounded-xl font-bold text-sm uppercase tracking-wider transition-all duration-300
                        ${timeView === t 
                          ? 'text-white bg-gradient-to-r from-[#2F86A6] to-[#34BE82] shadow-lg' 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-gradient-to-br from-[#34BE82]/10 to-[#2FDD92]/10 rounded-2xl p-6 border border-[#3341551a] shadow-lg">
                  <div className="text-3xl font-black text-[#34BE82] mb-2">
                ...
                <div className="bg-gradient-to-br from-[#F2F013]/10 to-[#FF6B35]/10 rounded-2xl p-6 border border-[#3341551a] shadow-lg">
                  <div className="text-3xl font-black text-[#7A7A00] mb-2 capitalize">
                    {timeView.toLowerCase()}
                  </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-[#64748B] font-medium">
                  Showing expenses for {timeView.toLowerCase()} of{' '}
                  {timeView === 'Month' 
                    ? new Date().toLocaleDateString('en-US', { month: 'long', year: 'numeric' })
                    : 'current week'
                  }
