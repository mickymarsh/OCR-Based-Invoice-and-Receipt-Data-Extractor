...
const ExpenseCard = ({ title, amount, icon, color, onClick }) => {
  return (
    <button
      onClick={onClick}
      className={`${color} backdrop-blur-0 p-6 rounded-2xl border border-[#3341551a] text-center transition-all duration-300 hover:scale-[1.02] hover:shadow-lg transform`}
    >
      <div className="w-16 h-16 bg-gradient-to-br from-[#2F86A6]/10 to-[#34BE82]/10 rounded-2xl flex items-center justify-center mx-auto mb-4 border border-[#3341551a]">
        <span className="text-2xl">{icon}</span>
      </div>
      <h3 className="text-[#0F172A] text-xl font-bold mb-2 tracking-wide">{title}</h3>
      <p className="text-2xl font-black text-[#2F86A6]">Rs. {amount}</p>
    </button>
  );
};
...
const ExpenseRow = ({ date, name, category, amount, categoryColor }) => {
  return (
    <tr className="border-b border-[#3341551a] hover:bg-gradient-to-r hover:from-[#2F86A6]/5 hover:to-[#34BE82]/5 transition-all duration-300">
      <td className="py-5 px-6 text-[#2F86A6] font-medium">{date}</td>
      <td className="py-5 px-6 text-[#0F172A] font-semibold">{name}</td>
      ...
      <td className="py-5 px-6 text-[#0F172A] font-black text-lg">Rs. {amount}</td>
    </tr>
  );
};
    ...
    <main className="min-h-screen bg-gradient-to-br from-[#F5F7FA] to-white relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="pt-8 px-8">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
              <div>
                <h1 className="text-5xl md:text-6xl font-black text-transparent bg-gradient-to-r from-[#2F86A6] via-[#34BE82] to-[#2FDD92] bg-clip-text mb-4 tracking-tight">
                  Hi, {userName}!
                </h1>
        ...
        <div className="px-8 mb-8">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white/80 p-10 rounded-3xl border border-[#3341551a] shadow-xl">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                {/* Actual Expenses */}
                <div className="space-y-4">
                  <h2 className="text-3xl font-black text-[#0F172A] tracking-wide">Total Expenses</h2>
                  <p className="text-5xl font-black text-transparent bg-gradient-to-r from-[#2F86A6] to-[#34BE82] bg-clip-text">
                    Rs. {totalExpenses.toLocaleString("en-LK", { minimumFractionDigits: 2 })}
                  </p>
                  <p className="text-[#2F86A6] font-semibold text-lg">Spent this month</p>
                </div>

                {/* Expected Expenses */}
                <div className="space-y-4">
                  <h2 className="text-3xl font-black text-[#0F172A] tracking-wide">Expected Expenses</h2>
                  <p className="text-5xl font-black text-transparent bg-gradient-to-r from-[#34BE82] to-[#2FDD92] bg-clip-text">
                    Rs. {expectedExpenses.toLocaleString("en-LK", { minimumFractionDigits: 2 })}
                  </p>
                  <div className="flex items-center space-x-6">
                    <p className="text-[#34BE82] font-semibold text-lg">Monthly budget</p>
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm text-[#7A7A00] font-bold">
              ...
              <div className="mt-8 pt-8 border-t border-[#3341551a]">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-sm text-[#64748B] font-semibold uppercase tracking-wider">Remaining</p>
                    <p
        ...
        <div className="px-8 mb-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-black text-[#0F172A] mb-8 tracking-wide">Expense Categories</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              <ExpenseCard
                title="Food"
                amount={categoryExpenses.food.toLocaleString("en-LK", { minimumFractionDigits: 2 })}
                icon="🍔"
                color="bg-gradient-to-br from-[#34BE82]/20 to-[#2FDD92]/10"
              ...
              <ExpenseCard
                ...
                icon="🚗"
                color="bg-gradient-to-br from-[#2F86A6]/20 to-[#34BE82]/10"
              ...
              <ExpenseCard
                ...
                icon="⚡"
                color="bg-gradient-to-br from-[#F2F013]/25 to-[#F2F013]/10"
              ...
              <ExpenseCard
                ...
                icon="🎬"
                color="bg-gradient-to-br from-purple-500/15 to-purple-600/10"
              ...
              <ExpenseCard
                ...
                icon="🛍️"
                color="bg-gradient-to-br from-pink-500/15 to-pink-600/10"
              ...
              <ExpenseCard
                ...
                icon="🏥"
                color="bg-gradient-to-br from-red-500/15 to-red-600/10"
        ...
        <div className="px-8 pb-16">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-black text-[#0F172A] mb-8 tracking-wide">Latest Expenses</h2>
            <div className="bg-white/90 rounded-3xl border border-[#3341551a] overflow-hidden shadow-xl">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gradient-to-r from-[#2F86A6]/10 to-[#34BE82]/10">
                    <tr>
                      <th className="py-6 px-6 text-left text-[#0F172A] font-black text-lg tracking-wider">Date</th>
                      <th className="py-6 px-6 text-left text-[#0F172A] font-black text-lg tracking-wider">Expense Name</th>
                      <th className="py-6 px-6 text-left text-[#0F172A] font-black text-lg tracking-wider">Category</th>
                      <th className="py-6 px-6 text-left text-[#0F172A] font-black text-lg tracking-wider">Amount</th>
                    </tr>
                  </thead>
                  <tbody>
