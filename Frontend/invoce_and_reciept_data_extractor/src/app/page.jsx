...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-500 via-gray-200 to-teal-600 relative overflow-hidden">
      {/* Falling Stars / Snowflakes */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute left-[5%] w-1 h-1 bg-white/100 rounded-full animate-star-fall shadow-lg shadow-white/80" style={{ animationDelay: "0s" }}></div>
        <div className="absolute left-[35%] w-1 h-1 bg-white/100 rounded-full animate-star-fall-long shadow-lg shadow-white/80" style={{ animationDelay: "4s" }}></div>
        <div className="absolute left-[65%] w-0.5 h-0.5 bg-white/100 rounded-full animate-star-fall-fast shadow-lg shadow-white/80" style={{ animationDelay: "2.5s" }}></div>
        <div className="absolute left-[30%] w-1.5 h-1.5 bg-white/100 rounded-full animate-star-fall-reverse shadow-lg shadow-white/80" style={{ animationDelay: "4.5s" }}></div>
        <div className="absolute left-[60%] w-1.5 h-1.5 bg-white/100 rounded-full animate-star-fall-reverse shadow-lg shadow-white/80" style={{ animationDelay: "1.2s" }}></div>
        <div className="absolute left-[90%] w-1.5 h-1.5 bg-white/100 rounded-full animate-star-fall shadow-lg shadow-white/80" style={{ animationDelay: "0.8s" }}></div>
        <div className="absolute left-[32%] w-1.5 h-1.5 bg-white/100 rounded-full animate-star-fall shadow-lg shadow-white/80" style={{ animationDelay: "5.2s" }}></div>
        <div className="absolute left-[62%] w-1.5 h-1.5 bg-white/100 rounded-full animate-star-fall-fast shadow-lg shadow-white/80" style={{ animationDelay: "0.3s" }}></div>
        <div className="absolute left-[92%] w-1.5 h-1.5 bg-white/100 rounded-full animate-star-fall-long shadow-lg shadow-white/80" style={{ animationDelay: "1.7s" }}></div>
        ...
        {/* Soft glow orbs */}
        <div className="absolute top-20 left-[20%] w-80 h-80 bg-blue-400/10 rounded-full filter blur-3xl"></div>
        <div className="absolute top-40 left-[60%] w-72 h-72 bg-teal-400/10 rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-40 left-[40%] w-64 h-64 bg-cyan-400/10 rounded-full filter blur-3xl"></div>
        <div className="absolute top-1/3 left-[80%] w-60 h-60 bg-emerald-400/10 rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-1/4 left-[10%] w-70 h-70 bg-indigo-400/10 rounded-full filter blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-8 max-w-6xl mx-auto pb-32">
          {/* Feature 1 */}
          <div className="bg-white/70 backdrop-blur-sm p-6 rounded-xl border border-teal-100 text-center shadow-md">
            <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <span className="text-2xl">📄</span>
            </div>
            <h3 className="text-teal-900 text-xl font-semibold mb-3">Instant Processing</h3>
          ...
          <div className="bg-white/70 backdrop-blur-sm p-6 rounded-xl border border-teal-100 text-center shadow-md">
            ...
            <h3 className="text-teal-900 text-xl font-semibold mb-3">Precision Accuracy</h3>
            <p className="text-teal-700">
          ...
          <div className="bg-white/70 backdrop-blur-sm p-6 rounded-xl border border-teal-100 text-center shadow-md">
            ...
            <h3 className="text-teal-900 text-xl font-semibold mb-3">Secure Storage</h3>
            <p className="text-teal-700">
